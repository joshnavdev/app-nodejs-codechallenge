...
export class InitMigration1749369242116 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "transactions" ("transaction_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "account_external_id_debit" character varying NOT NULL, "account_external_id_credit" character varying NOT NULL, "amount" numeric(10,2) NOT NULL, "created_at" TIMESTAMP NOT NULL,"transaction_type_id" integer, "transaction_status_id" integer, CONSTRAINT "PK_9162bf9ab4e31961a8f7932974c" PRIMARY KEY ("transaction_id"))`);
